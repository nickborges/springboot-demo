...
* exemplo de chamada:
    * http://localhost:8082/user/all?page=0&size=10&sort=name,asc
    * localhost:8082/user/all?page=0&size=10&sort=name,asc&sort=id,asc
...
* Exemplo de chamada para o Actuator:
    ````    
    curl --location --request GET 'http://localhost:8082/actuator' \
    --header 'Authorization: Bearer eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJBdXRlbnRpY2Fkb3IgRGVtbyIsInN1YiI6IjEiLCJpYXQiOjE1OTMzNTY2MDYsImV4cCI6MTU5Mzk1NjYwNn0.JlJzqcr7QZ3aSzGkwqczOtinkSBegmLc79HyiY7Lurw'
    ````
...
* application.propertires
    ...
    * spring.boot.admin.client.url=http://localhost:8081/web/monitoramento
